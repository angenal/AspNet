    ...
    public partial class ConsoleControl : UserControl
    {
        ...
        void richTextBoxConsole_PreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (inReadOnlyZone)
            {
                ...
                e.Handled = !(e.Key == Key.Left || e.Key == Key.Right || e.Key == Key.Up || e.Key == Key.Down ||
        ...
        public void WriteOutput(string output, Color color)
        {
            ...
            {
                //  Write the output.
                TextRange range = new TextRange(richTextBoxConsole.GetEndPointer(), richTextBoxConsole.GetEndPointer()) { Text = output };
        ...
        public void StartProcess(ProcessStartInfo processStartInfo)
        {
            ...
            if (ShowDiagnostics)
            {
                ...
                if (string.IsNullOrWhiteSpace(processStartInfo.Arguments)) WriteOutput("." + Environment.NewLine, Color.FromArgb(255, 0, 255, 0));
                else WriteOutput(" with arguments " + processStartInfo.Arguments + "." + Environment.NewLine, Color.FromArgb(255, 0, 255, 0));
            }
            ...
            RunOnUIDispatcher(() =>
            {
                ...
                if (IsInputEnabled) richTextBoxConsole.IsReadOnly = false;
