...
namespace EOPDFDemo.Acm.AdvancedFormatting
{
    public class Table : Demo
    {
        ...
        public override string RunDemo(Stream result, IDemoArgs args)
        {
            ...
            CreateTableRow(table, "Alice in Wonderland (2010)", "BV", "$334,191,110");
            ...
            return         @"<pre class='coloredcode'><span class='kwd'>public override string</span> RunDemo(Stream result, IDemoArgs args)
{
    ...
    CreateTableRow(table, <span class='st'>&quot;Alice in Wonderland (2010)&quot;</span>, <span class='st'>&quot;BV&quot;</span>, <span class='st'>&quot;$334,191,110&quot;</span>);
...
<span class='kwd'>End Sub</span></pre>";
        ...
        public override string GetInstructions()
        {
            return @"
<p>
This sample demonstrates how to use a table.
To create a table, simply create an <b>AcmTable</b>
object and then create one to many <b>AcmTableRow</b>
objects. Each <b>AcmTableRow</b> contains one to
many <b>AcmTableCell</b> object. The number of 
columns and width of each column is provided to
<b>AcmTable</b> through its constructor.
</p>
<p>
See <a href=""javascript:eo_OpenHelp('Acm/Advanced Formatting/table.html')"">here</a> 
for more information about using tables.
</p>
";
        }
    }
