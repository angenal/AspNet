...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Editor_Designs_Style_2_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    Similar to <b>Style 1</b>, this style also </B>uses <b>CustomHeaderTemplate</b> 
    to define a custom toolbar, but includes more command items.
</p>
...
<eo:Editor runat="server" ID="Editor1" Width="500px" HTMLBodyCssClass="demo_editor_body" FooterVisible="False"
    HighlightColor="255, 255, 192" Height="250px" ToolBarSet="Custom" SpellCheckerID="SpellChecker1"
    ...
    <CustomHeaderTemplate>
        <DIV style="OVERFLOW-Y: hidden; HEIGHT: 27px">
            <eo:ToolBar ID="ToolBar1" runat="server" BackgroundImageRight="00100402" BackgroundImage="00100403" BackgroundImageLeft="00100401"
                Width="100%" SeparatorImage="00100404">
                <ItemTemplates>
                ...
                <Items>
                    ...
                    <eo:ToolBarItem ToolTip="Insert Line" ImageUrl="00101049" CommandName="InsertLine"></eo:ToolBarItem>
                </Items>
            </eo:ToolBar>
        </DIV>
        <DIV style="OVERFLOW-Y: hidden; HEIGHT: 28px">
            <eo:ToolBar ID="ToolBar2" runat="server" BackgroundImageRight="00100402" BackgroundImage="00100403" BackgroundImageLeft="00100401"
                Width="100%" SeparatorImage="00100404">
                <ItemTemplates>
                    <eo:ToolBarItem Type="Custom">
                        <HoverStyle CssText="background-color:transparent;border-bottom-style:none;border-left-style:none;border-right-style:none;border-top-style:none;padding-bottom:1px;padding-left:2px;padding-right:2px;padding-top:2px;background-image:url('Blank');"></HoverStyle>
                ...
                <NormalStyle CssText="PADDING-RIGHT: 7px; PADDING-LEFT: 7px; FONT-SIZE: 12px; PADDING-BOTTOM: 4px; CURSOR: hand; PADDING-TOP: 4px; FONT-FAMILY: Tahoma"></NormalStyle>
                <Items>
                    <eo:ToolBarItem ToolTip="Fore Color" ImageUrl="00101029" CommandName="ForeColor" Type="DropDownMenu"></eo:ToolBarItem>
                    <eo:ToolBarItem ToolTip="Back Color" ImageUrl="00101030" CommandName="BackColor" Type="DropDownMenu"></eo:ToolBarItem>
                    <eo:ToolBarItem Type="Separator"></eo:ToolBarItem>
                    ...
                    <eo:ToolBarItem ToolTip="Numbered List" ImageUrl="00101020" CommandName="Numbered List"></eo:ToolBarItem>
                    <eo:ToolBarItem Type="Separator"></eo:ToolBarItem>
                    <eo:ToolBarItem ToolTip="Indent" ImageUrl="00101027" CommandName="Indent"></eo:ToolBarItem>
                    <eo:ToolBarItem ToolTip="Outdent" ImageUrl="00101028" CommandName="Outdent"></eo:ToolBarItem>
                    <eo:ToolBarItem Type="Separator"></eo:ToolBarItem>
                    <eo:ToolBarItem ToolTip="Design Mode" ImageUrl="00101052" CommandName="DesignMode"></eo:ToolBarItem>
                    <eo:ToolBarItem ToolTip="HTML Mode" ImageUrl="00101051" CommandName="HTMLMode"></eo:ToolBarItem>
                    <eo:ToolBarItem Type="Separator"></eo:ToolBarItem>
