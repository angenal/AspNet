...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AutoFill2.aspx.cs" Inherits="Demos_Splitter_Features_Auto_Fill_Window_AutoFill2" %>
...
<body>
        <form id="Form1" method="post" runat="server">
            <div style="HEIGHT:50px">
                Only the right and the bottom edge of the splitter automatically resizes.
                This allows you to place contents before the splitter and it will not be
