...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Grid_Features_Row_Selection_Demo" Title="Untitled Page" %>
...
<p>
    When <b>FullRowMode</b> is set to <b>True</b>, clicking any cell in a row 
    select the whole row and fires <b>ClientSideOnItemSelected</b> event.
</p>
<eo:Grid id="Grid1" runat="server" FixedColumnCount="1" BorderColor="#7F9DB9" BorderWidth="1px"
    ...
    Font-Names="Tahoma" Width="380px" Height="200px" IsCallbackByMe="False" ClientSideOnItemSelected="OnItemSelected">
