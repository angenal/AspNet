...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demo2.aspx.cs" Inherits="Demos_File_Explorer_Features_Filtering_Files___By_Extension_Demo2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        function upload_done()
        {
            ...
            <p>
                EO.Web FileExplorer can filter files by file extension. For example, you may wish
                to browse image files only. To use this features, set the FileExplorer control's
                <strong>AllowedExtension</strong> property.
            </p>
            <p>
                <asp:LinkButton runat="server" ID="LinkButton1" OnClick="LinkButton1_Click">Set AllowedExtension to show image files only</asp:LinkButton>
            </p>
            <p>
                <asp:LinkButton runat="server" ID="LinkButton2" OnClick="LinkButton2_Click">Clear AllowedExtension to show all files</asp:LinkButton>
            </p>
