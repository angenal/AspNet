...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Menu_Programming_Data_Binding_Populate_from_DataTable__Parent___Child_Key_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>This sample demonstrates how to populate an EO.Web Menu from a <span class="highlight">
        DataTable</span> object.
</p>
<h4>The Data</h4>
