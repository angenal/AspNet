...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Grid_Features_Deleting_Item_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    Use a <b>DeleteCommandColumn</b> to allow deleting items on the client side. 
    Like all other editing actions, deleting is also logged on the client side 
    first and then transferred to the server side when the page posts back. When
    an item is deleted, it is not removed from the grid's <b>Items</b> collection.
    It is only marked as deleted. You can get a list of deleted item through
    <b>DeletedItems</b>.
</p>
<p>
    DeleteCommandColumn deletes the item without asking users to confirm it.
    <a href="javascript:GoToDemo('delete_with_confirmation', 0);">This sample</a> 
    demonstrates how to delete with confirmation.
</p>
<eo:CallbackPanel id="CallbackPanel1" runat="server" Height="210px" Width="480px" Triggers="{ControlID:Button1;Parameter:}"
    AutoDisableContents="True">
    <eo:Grid id="Grid1" runat="server" Height="180px" Width="400px" AllowColumnReorder="True"
        ...
        IsCallbackByMe="False" KeyField="TopicID">
        ...
        <Columns>
            ...
            <eo:DeleteCommandColumn Width="80"></eo:DeleteCommandColumn>
