...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AutoResize.aspx.cs" Inherits="Demos_Editor_Features_Auto_Resize_AutoResize" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <eo:Editor runat="server" ID="Editor1" Width="100%" HighlightColor="255, 255, 192"
                ToolBarSet="Basic" HtmlBodyCssClass="demo_editor_body" Height="300px" Html="<p>&#13;&#10;This editor's <strong>Width</strong> is set to <strong>100%</strong>. Resize the window and see the editor automatically adjusts the size.&#13;&#10;</p>&#13;&#10;<p>&#13;&#10;Percentage height is also supported. However most of the time the editor is placed in the Web Form as a direct child of the HTML form element and the height of the HTML form element is not necessary the height of the browser window. Using percentage height on this scenario has little practical use. In order to use percentage height, place it inside another HTML element and set that HTML element�s height accordingly. &#13;&#10;</p>&#13;&#10;"
