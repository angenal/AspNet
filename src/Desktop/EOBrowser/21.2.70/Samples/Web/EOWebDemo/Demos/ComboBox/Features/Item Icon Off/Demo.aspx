...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_ComboBox_Features_Item_Icon_Off_Demo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
    <p>
        All built-in EO.Web CombBox's skins set <b>IconStyle</b>
        to reserve a 16 pixels by 16 pixels space for the icon.
        To completely turn icon off, you can simply apply <b>display:none</b>
        on the IconStyle property. 
    </p>
