...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demo2.aspx.cs" Inherits="Demos_File_Explorer_Features_Setting_Root_Folder_Demo2" %>
...
<body>
    ...
    <div>
        ...
        function upload_done()
        {
            ...
            <p>
                Use the FileExplorer control's <strong>RootFolder</strong> to specify the root folder 
                of the FileExplorer control.
            </p>
            <p>
                <asp:LinkButton Runat="server" ID="LinkButton1" OnClick="LinkButton1_Click">Set to "Files"</asp:LinkButton>
            </p>
            <p>
                <asp:LinkButton Runat="server" ID="LinkButton2" OnClick="LinkButton2_Click">Set to "Files/Images"</asp:LinkButton>
            </p>
            <p>
                <asp:LinkButton Runat="server" ID="LinkButton3" OnClick="LinkButton3_Click">Set to "Files/Media"</asp:LinkButton>
            </p>
