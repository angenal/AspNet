<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demo2.aspx.cs" Inherits="Demos_File_Explorer_Features_Browse_Only_Root_Folders_Demo2" %>
...
<body>
    ...
    <div>
        ...
        function upload_done()
        {
            ...
            <p>
                EO.Web FileExplorer can include one or more browse only root
                folders. Set property <strong>BrowseOnlyRootFolders</strong>
                to use this feature.
            </p>
            <p>
                The second and the third root node are browse-only in the 
                following sample.   
            </p>
            <eo:FileExplorer id="FileExplorer1" runat="server" RootFolder="~/Demos/File Explorer/Files" AllowCreateFolder="True"
                ...
                BrowseOnlyRootFolders="~/Demos|~/Images">
                <LayoutTemplate>
