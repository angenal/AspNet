...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Grid_Designs_Windows_XP_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<P>
    <eo:Grid id="Grid1" Height="200px" GoToBoxVisible="True" GridLines="Both" BorderColor="#7F9DB9"
        GridLineColor="220, 223, 228" ColumnHeaderDividerImage="00050103" Width="450px" Font-Names="Tahoma"
        Font-Size="8.75pt" BorderWidth="1px" runat="server" FixedColumnCount="1" ColumnHeaderAscImage="00050104"
