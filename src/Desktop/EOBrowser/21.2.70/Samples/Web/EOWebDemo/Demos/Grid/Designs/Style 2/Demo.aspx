...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Grid_Designs_Style_2_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    <eo:Grid runat="server" id="Grid1" BorderColor="#C7D1DF" BorderWidth="1px" GridLines="Both"
        FixedColumnCount="1" ColumnHeaderDescImage="00050304" GridLineColor="199, 209, 223" Width="380px"
        ItemHeight="19" ColumnHeaderAscImage="00050303" Height="200px"
        Font-Size="9pt" Font-Names="Verdana" ColumnHeaderDividerImage="00050302">
        <ItemStyles>
            <eo:GridItemStyleSet>
                ...
                <CellStyle CssText="padding-left:8px;padding-top:2px; color:#336699;"></CellStyle>
