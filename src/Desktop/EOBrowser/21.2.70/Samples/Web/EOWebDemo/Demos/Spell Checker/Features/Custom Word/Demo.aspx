...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Spell_Checker_Features_Custom_Word_Demo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
    <p>
        EO.Web SpellChecker allows user to define custom word. See remark
        section for details about using this feature.
    </p>
    <asp:TextBox Runat="server" id="TextBox1" Height="200px" Width="400px" TextMode="MultiLine">This sampel uses a dialog to display the spell errors. Please refer to the product documentaton under section &quot;Using Spell Checker Dialog&quot; for more deteils.</asp:TextBox>
    <eo:SpellChecker id="SpellChecker1" runat="server" 
        DialogID="SpellCheckerDialog1" ControlToCheck="TextBox1"
        StartButton="Button1" oncustomword="SpellChecker1_CustomWord"></eo:SpellChecker>
