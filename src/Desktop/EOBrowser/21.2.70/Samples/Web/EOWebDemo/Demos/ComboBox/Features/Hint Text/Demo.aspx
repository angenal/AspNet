...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_ComboBox_Features_Hint_Text_Demo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
    <p>
    EO.Web ComboBox can display a "hint text" when the ComboBox is empty.
    Use <b>HintText</b> to customize the text and <b>HintTextStyle</b>
    to customize the style of the hint text.
    </p>
    <p>
    You can use any valid HTML in <b>HintText</b>. This sample uses &lt;img&gt;
    tag to display a smiling image.
    </p>
    <eo:ComboBox runat="server" ID="ComboBox1" ControlSkinID="None" 
        DefaultIcon="00101070" 
        HintText="&amp;lt;Type here&nbsp;&lt;img style='position:relative;top:1px;' src='smile.gif' /&gt; &amp;gt;" 
        Width="150px">
