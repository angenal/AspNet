...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_File_Explorer_Features_Permission_Control_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<script type="text/javascript">
function splitter_resize_handler(splitter)
{
...
function upload_begin()
{
    ...
    splitter_resize_handler(eo_GetObject("LeftSplitter"));
}
...
<p>
    EO.Web FileExplorer provides several properties to control whether user are 
    allowed to create/rename/delete folder or files.
</p>
<table border="0">
    <tr>
        <td>
            <asp:CheckBox id="chkAllowCreateFolder" runat="server" Text="Allow Create Folder" Checked="True"
                AutoPostBack="True" OnCheckedChanged="chkAllowCreateFolder_CheckedChanged"></asp:CheckBox>&nbsp;
        </td>
        <td>
            <asp:CheckBox id="chkAllowRenameFolder" runat="server" Text="Allow Rename Folder" Checked="True"
                AutoPostBack="True" OnCheckedChanged="chkAllowRenameFolder_CheckedChanged"></asp:CheckBox>&nbsp;
        </td>
        <td>
            <asp:CheckBox id="chkAllowDeleteFolder" runat="server" Text="Allow Delete Folder" Checked="True"
                AutoPostBack="True" OnCheckedChanged="chkAllowDeleteFolder_CheckedChanged"></asp:CheckBox>&nbsp;
        </td>
    </tr>
    <tr>
        <td>
            <asp:CheckBox id="chkAllowUpload" runat="server" Text="Allow Upload" Checked="True" AutoPostBack="True"
             OnCheckedChanged="chkAllowUpload_CheckedChanged"></asp:CheckBox>&nbsp;
        </td>
        <td>
            <asp:CheckBox id="chkAllowRenameFile" runat="server" Text="Allow Rename File" Checked="True" 
            AutoPostBack="True" OnCheckedChanged="chkAllowRenameFile_CheckedChanged"></asp:CheckBox>&nbsp;
        </td>
        <td>
            <asp:CheckBox id="chkAllowDeleteFile" runat="server" Text="Allow Delete File" 
            Checked="True" AutoPostBack="True" OnCheckedChanged="chkAllowDeleteFile_CheckedChanged"></asp:CheckBox>&nbsp;
        </td>
    </tr>
</table>
<br>
<eo:FileExplorer id="FileExplorer1" runat="server" RootFolder="~/Demos/File Explorer/Files" AllowCreateFolder="True"
    ...
    <LayoutTemplate>
        <eo:splitter id="LeftSplitter" runat="server" Height="280px" Width="500px" ControlSkinID="None"
