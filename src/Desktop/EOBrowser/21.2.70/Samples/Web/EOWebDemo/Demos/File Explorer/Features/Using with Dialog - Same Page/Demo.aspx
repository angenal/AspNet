...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_File_Explorer_Features_Using_with_Dialog___Same_Page_Demo" Title="Untitled Page" %>
...
<p>The FileExplorer control is often used together with a dialog. This sample uses 
    a dialog to display a FileExplorer control and also use the FileExplorer 
    control's client side JavaScript API to retrieve user's selection.
</p>
<eo:dialog id="Dialog1" CancelButton="Button2" AcceptButton="Button1" ClientSideOnAccept="dialog_accept"
    CloseButtonUrl="00020440" Height="216px" HeaderHtml='<div style="padding-top:5px">Browse File</div>'
    MinHeight="100" Width="320px" ControlSkinID="None" MinWidth="150" HeaderImageHeight="27"
    HeaderImageUrl="00020441" AllowResize="True" runat="server">
    <ContentTemplate>
...
</eo:dialog><asp:textbox id="TextBox1" Width="300px" Runat="server"></asp:textbox><input onclick="eo_GetObject('Dialog1').show();" type="button" value="Browse">
</asp:Content>
