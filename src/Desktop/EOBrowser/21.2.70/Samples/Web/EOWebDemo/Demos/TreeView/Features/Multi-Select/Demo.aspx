...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_TreeView_Features_Multi_Select_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    Set <b>AllowMultiSelect</b> to <b>true</b> to enable multi-select. When 
    multi-select is enabled, user can select multiple nodes by holding control key. 
    Note all the selected nodes must belong to the same parent node.
</p>
<eo:TreeView runat="server" id="tvMultiSelect" Width="200px" ControlSkinID="None" Height="250px"
    AutoSelectSource="ItemClick" AllowMultiSelect="True">
