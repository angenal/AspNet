...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Editor_Features_Spell_Checking_Demo" Title="Untitled Page" %>
...
<eo:Editor runat="server" id="Editor1" Width="500px" HighlightColor="255, 255, 192" Height="320px"
    ToolBarSet="Basic" HtmlBodyCssClass="demo_editor_body" Html="<p>EO.Web Editor is closely integrated with EO.Web SpellChecker. &#13;&#10;Follow these simple steps to enable spell checking on the editor:</p>&#13;&#10;&#13;&#10;<ol>&#13;&#10;   <li>Add a toolbar item with its <strong>CommandName</strong> set to &#13;&#10;   <strong>SpellCheck</strong>;</li>&#13;&#10;   <li>Add a SpellChecker and a SpellCheckerDialog control onto&#13;&#10;   the form;</li>&#13;&#10;   <li>Set the Editor's <strong>SpellCheckerID</strong> to the ID of the Spell&#13;&#10;   Checker control;</li>&#13;&#10;   <li>Set the SpellChecker's <strong>DialogID</strong> to the ID of the&#13;&#10;   SpellCheckerDialog control;&#13;&#10;</ol>&#13;&#10;&#13;&#10;<p>Run the page and chek for mispelled words!</p>"
    SpellCheckerID="SpellChecker1" TextAreaCssFile="~\EOWebDemo.css"
...
<eo:SpellCheckerDialog id="SpellCheckerDialog1" Width="320px" Height="216px" runat="server" ControlSkinID="None"
    CloseButtonUrl="00020440" HeaderHtml="Dialog Title" MinHeight="100" MinWidth="150" HeaderImageHeight="27"
    HeaderImageUrl="00020441" HeaderHtmlFormat='<div style="padding-top:4px">{0}</div>' AllowResize="True">
    <FooterStyleActive CssText="padding-right: 4px; padding-left: 4px; font-size: 8pt; padding-bottom: 4px; padding-top: 4px; font-family: tahoma"></FooterStyleActive>
    <HeaderStyleActive CssText="background-image:url(00020442);color:#444444;font-family:'trebuchet ms';font-size:10pt;font-weight:bold;padding-bottom:7px;padding-left:8px;padding-right:0px;padding-top:0px;"></HeaderStyleActive>
    <ContentStyleActive CssText="background-color:#f0f0f0;font-family:tahoma;font-size:8pt;padding-bottom:4px;padding-left:4px;padding-right:4px;padding-top:4px"></ContentStyleActive>
    <BorderImages BottomBorder="00020409,00020429" RightBorder="00020407,00020427" TopRightCornerBottom="00020405,00020425"
