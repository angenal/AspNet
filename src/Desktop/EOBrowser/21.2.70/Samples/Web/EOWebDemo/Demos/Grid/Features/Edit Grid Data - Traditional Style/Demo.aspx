...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Grid_Features_Edit_Grid_Data___Traditional_Style_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    EO.Web Grid supports <b>EditCommandColumn</b> that displays an <b>Edit</b> link 
    button in the column. User can click the button to enter edit a row. Unlike 
    standard ASP.NET EditCommandColumn is, EO.Web Grid does not post back when user 
    finishes editing the row. It loggs all changes until page posts back, at which 
    you can either handle <b>ItemChanged</b> event or use <b>ChangedItems</b> to 
    get a list of changed items and save the changes back into your data source.
</p>
<eo:CallbackPanel runat="server" id="CallbackPanel1" Height="210px" Width="480px" Triggers="{ControlID:Button1;Parameter:}"
    AutoDisableContents="True">
    <P>
        <eo:Grid id="Grid1" Width="400px" Height="180px" runat="server" KeyField="TopicID" IsCallbackByMe="False"
            BorderWidth="1px" Font-Size="8.75pt" Font-Names="Tahoma" ColumnHeaderDividerImage="00050103"
            GridLineColor="220, 223, 228" BorderColor="#7F9DB9" GridLines="Both" GoToBoxVisible="True"
            FixedColumnCount="1" ColumnHeaderAscImage="00050104" ColumnHeaderDescImage="00050105"
            AllowColumnReorder="True" OnItemChanged="Grid1_ItemChanged">
            ...
            <Columns>
                ...
                <eo:EditCommandColumn></eo:EditCommandColumn>
                <eo:DateTimeColumn HeaderText="Posted At" DataField="PostedAt" Width="130"></eo:DateTimeColumn>
