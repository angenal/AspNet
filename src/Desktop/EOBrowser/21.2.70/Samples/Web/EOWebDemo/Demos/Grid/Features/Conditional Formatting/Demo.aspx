...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Grid_Features_Conditional_Formatting_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    EO.Web supports conditional formatting --- that is, applying different styles 
    based on conditions. The following sample displays all posts from "eo_support" 
    as blue. See the <b>Remarks</b> tab for a brief summary of how conditional 
    formatting is supported. For more details, please refer to the online 
    documentation.
</p>
<P>
    <eo:Grid id="Grid1" runat="server" FixedColumnCount="1" BorderColor="#7F9DB9" BorderWidth="1px"
        ...
        <ItemStyles>
            ...
            <eo:GridItemStyleSet StyleSetID="support">
                <ItemHoverStyle CssText="background-color: whitesmoke"></ItemHoverStyle>
                <SelectedStyle CssText="background-color:#316ac5;color:white;"></SelectedStyle>
                <CellStyle CssText="padding-left:8px;padding-top:2px;"></CellStyle>
                <ItemStyle CssText="background-color:white;color:blue;"></ItemStyle>
                <FixedColumnCellStyle CssText="background-color:#ebeadb;border-bottom-color:#d6d2c2;border-bottom-style:solid;border-bottom-width:1px;border-left-color:#faf9f4;border-left-style:solid;border-left-width:1px;border-right-color:#d6d2c2;border-right-style:solid;border-right-width:1px;border-top-color:#faf9f4;border-top-style:solid;border-top-width:1px;color:blue;padding-right:10px;text-align:right;"></FixedColumnCellStyle>
            </eo:GridItemStyleSet>
        </ItemStyles>
