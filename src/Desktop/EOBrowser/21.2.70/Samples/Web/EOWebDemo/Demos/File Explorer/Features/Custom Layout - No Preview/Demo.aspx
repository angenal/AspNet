...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_File_Explorer_Features_Custom_Layout___No_Preview_Demo" Title="Untitled Page" %>
...
<p>
    The following File Explorer includes the folder view and 
    file list, but not the preview panel.
</p>
<eo:FileExplorer id="FileExplorer1" runat="server" RootFolder="~/Demos/File Explorer/Files" AllowCreateFolder="True"
    ...
    <LayoutTemplate>
        <eo:splitter id="LeftSplitter" runat="server" Height="320px" Width="500px" ControlSkinID="None"
