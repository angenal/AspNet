...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Demo.aspx.cs" Inherits="Demos_Editor_Features_Emoticon___Custom_Demo"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="demo" runat="Server">
    ...
    <eo:Editor runat="server" ID="Editor1" Width="500px" HighlightColor="255, 255, 192"
        Height="320px" ToolBarSet="Basic" HtmlBodyCssClass="demo_editor_body" Html="<p>This sample uses a set of custom emoticons. Custom emoticons can be used if you wish to replace the default icons or default tooltip text (in English).</p>&#13;&#10;<p>For details about how to use custom emoticons, please refer to the product documentation under<em>EO.Web HTML Editor -&amp;gt; Localization -&amp;gt; Localizing emoticons</em>.</p>&#13;&#10;"
        EmoticonSet="Smiley" TextAreaCssFile="~\EOWebDemo.css" FileExplorerDialogID="FileExplorerDialog1"
        ...
        <CustomHeaderTemplate>
            <eo:ToolBar ID="HeaderToolBar0" runat="server" Width="100%" SeparatorImage="00100104"
                ...
                <Items>
                    <eo:ToolBarItem ToolTip="Fonts" CommandName="Fonts" Type="Custom">
                        <CustomItem>
                            <asp:DropDownList runat="server" ID="FontDropDown" Style="width: 110px">
                            </asp:DropDownList>
                        </CustomItem>
                    </eo:ToolBarItem>
                    ...
                    <eo:ToolBarItem ToolTip="Bold" ImageUrl="00101011" CommandName="Bold">
                    </eo:ToolBarItem>
                    <eo:ToolBarItem ToolTip="Italic" ImageUrl="00101012" CommandName="Italic">
                    </eo:ToolBarItem>
                    <eo:ToolBarItem ToolTip="Underline" ImageUrl="00101013" CommandName="Underline">
                    </eo:ToolBarItem>
                    ...
                    <eo:ToolBarItem ToolTip="Insert Emoticon" ImageUrl="00101050" CommandName="InsertEmoticon">
                    </eo:ToolBarItem>
                </Items>
            </eo:ToolBar>
        </CustomHeaderTemplate>
