...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Grid_Features_Keyboard_Navigation_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    Keyboard navigation can be enabled by setting <b>EnableKeyboardNavigation</b> to
    <b>true</b>. When keyboard navigation is enabled, user can use arrow keys to 
    move the selected item/cell, enter keys to enter/exit edit mode and escape key 
    to cancel edit.
</p>
<eo:Grid runat="server" id="Grid1" BorderColor="#7F9DB9" BorderWidth="1px" GridLines="Both"
    FixedColumnCount="1" ColumnHeaderDescImage="00050105" GridLineColor="220, 223, 228" Width="380px"
    ColumnHeaderAscImage="00050104" Height="200px" GoToBoxVisible="True"
    ...
    <Columns>
        ...
        <eo:TextBoxColumn HeaderText="Column 1"></eo:TextBoxColumn>
        <eo:TextBoxColumn HeaderText="Column 2"></eo:TextBoxColumn>
    </Columns>
