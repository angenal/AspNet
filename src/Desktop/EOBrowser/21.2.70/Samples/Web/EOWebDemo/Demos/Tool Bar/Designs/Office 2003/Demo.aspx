...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Tool_Bar_Designs_Office_2003_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    This ToolBar uses <b>BackgroundImageLeft</b>, <b>BackgroundImage</b> and <b>BackgroundImageRight</b>
    to create the Office 2003 style background. It also set <b>NormalStyle</b>, <b>DownStyle</b>
    and <b>HoverStyle</b> to create the highlight and down effect when mouse hovers 
    over a button or press a button down.
</p>
<p>
&nbsp;
</p>
<eo:ToolBar runat="server" id="ToolBar1" BackgroundImageRight="00100102" Width="400px" BackgroundImage="00100103"
    SeparatorImage="00100104" BackgroundImageLeft="00100101">
