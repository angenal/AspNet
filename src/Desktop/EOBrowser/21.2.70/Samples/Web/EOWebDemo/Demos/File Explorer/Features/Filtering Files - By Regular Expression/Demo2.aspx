...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demo2.aspx.cs" Inherits="Demos_File_Explorer_Features_Filtering_Files___By_Regular_Expression_Demo2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        function upload_done()
        {
            ...
            <p>
                EO.Web FileExplorer can filter files using a regular expression. For example, you
                may wish the FileExplorer to only display files that matches certain date/time stamp
                in the file name. To use this features, set the FileExplorer control's <strong>FileNameFilter</strong>
                property to a regular expression.
            </p>
            <p>
                <asp:LinkButton runat="server" ID="LinkButton1" OnClick="LinkButton1_Click">Set FileNameFilter to show files whose name starts with "2008-08"</asp:LinkButton>.
                Note the filter is only applied to file names, not directory names.
            </p>
            <p>
                <asp:LinkButton runat="server" ID="LinkButton2" OnClick="LinkButton2_Click">Clear FileNameFilter to show all files</asp:LinkButton>
            </p>
            <eo:FileExplorer ID="FileExplorer1" runat="server" RootFolder="~/Demos/File Explorer/Files"
                ...
                AllowUpload="True" AllowDeleteFile="True" EnableKeyboardNavigation="True" TargetControl="TextBox1"
                MaxUploadFileSize="10000" DemoMode="True">
                <LayoutTemplate>
