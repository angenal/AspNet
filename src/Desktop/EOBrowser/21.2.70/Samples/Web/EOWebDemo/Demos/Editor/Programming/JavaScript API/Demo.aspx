<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Editor_Programming_JavaScript_API_Demo" Title="Untitled Page" %>
...
{
    var editor = eo_GetObject("Editor1");
    editor.setHtml("<p>some new HTML text.</p>");
}

function InsertTextDemo()
{
    var editor = eo_GetObject("Editor1");
    editor.execCommand("InsertHTML", "This is a test!");
}
//<!--JS_SAMPLE_END-->
</script>
...
<eo:Editor runat="server" id="Editor1" Height="320px" ToolBarSet="Basic" HighlightColor="255, 255, 192"
    Width="500px" HtmlBodyCssClass="demo_editor_body" TextAreaCssFile="~\EOWebDemo.css" Html="<p>&#13;&#10;Test HTML text.&#13;&#10;</p>"
...
<p>
    <input type="button" onclick="GetTextDemo()" value="Get Text"> <input type="button" onclick="SetTextDemo()" value="Set Text">
    <input type="button" onclick="InsertTextDemo()" value="Insert Text">
</p>
</asp:Content>
