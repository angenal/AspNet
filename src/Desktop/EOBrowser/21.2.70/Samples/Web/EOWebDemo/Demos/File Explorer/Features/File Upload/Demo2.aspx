...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demo2.aspx.cs" Inherits="Demos_File_Explorer_Features_File_Upload_Demo2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        function upload_done()
        {
            ...
            <p>
                EO.Web FileExplorer allows user to upload files. The following sample demonstrates
                this feature.
            </p>
            <p>
                In order for user to upload files, <strong>AllowUpload</strong> must be set to true.
                You may also wish set <strong>AllowedExtension</strong> to restrict the type of
                files user can display/upload, and <strong>MaxUploadFileSize</strong> to restrict
                the file size.
            </p>
