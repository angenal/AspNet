...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_TreeView_Features_Drag_and_Drop_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    EO.Web TreeView supports drag and drop. To enable this feature, set <b>AllowDragDrop</b>
    to true. The following sample demonstrates this feature.
</p>
<p>
    All changes are persisted when the page posts back. Server side event <b>ItemMoved</b>
    event is also fired for each node that has been moved.
</p>
