...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Editor_Features_Customizing_Header_Demo" Title="Untitled Page" %>
...
<eo:Editor runat="server" id="Editor1" Width="500px" HighlightColor="255, 255, 192" Height="340px"
    ToolBarSet="Custom" HtmlBodyCssClass="demo_editor_body" Html="<p>This sample uses <strong>CustomHeaderTemplate</strong> to define a custom header. It also hides the footer by setting <strong>FooterVisible</strong> to False. </p>&#13;&#10;<p>Follow these steps to use this feature: </p>&#13;&#10;<ol>&#13;&#10;    <li>Right click the Editor control on your Web Form; </li>&#13;&#10;    <li>Select Template from the context menu, then select <strong>CustomHeaderTemplate</strong>; </li>&#13;&#10;    <li>Place any valid HTML or server control into <strong>CustomHeaderTemplate</strong>; </li>&#13;&#10;</ol>&#13;&#10;<p>Note the contents of the custom header do not automatically interact with the editor. JavaScript must be used to handle appropriate events and then call the editor's client side interface. This sample calls the editor's <strong>execCommand</strong> method when either the Design Mode or HTML Mode radio button is clicked. </p>&#13;&#10;<p />&#13;&#10;<p>&#13;&#10;As also demonstrated by this sample, toolBar with built-in commands can also be placed inside  <strong>CustomHeaderTemplate</strong>.&#13;&#10;</p>&#13;&#10;"
    FooterVisible="False" TextAreaCssFile="~\EOWebDemo.css" FileExplorerDialogID="FileExplorerDialog1" FileExplorerUrl="~/Demos/File Explorer/Explorer.aspx">
    ...
    <HeaderStyle CssText="border-bottom-color:gray;border-bottom-width:1px;border-left-color:gray;border-left-style:solid;border-left-width:1px;border-right-color:gray;border-right-style:solid;border-right-width:1px;border-top-color:gray;border-top-style:solid;border-top-width:1px;padding-top:4px;"></HeaderStyle>
    ...
    <CustomHeaderTemplate>
        <div class="normal">
            Select a mode: <input type="radio" name="editor_mode" checked="true" onclick="eo_GetObject('Editor1').execCommand('DesignMode');" />
            Design Mode <input type="radio" name="editor_mode" onclick="eo_GetObject('Editor1').execCommand('HTMLMode');" />
            HTML Mode
        </div>
