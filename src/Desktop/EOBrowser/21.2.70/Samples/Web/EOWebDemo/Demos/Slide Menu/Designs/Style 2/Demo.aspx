...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_Slide_Menu_Designs_Style_2_Demo" Title="Untitled Page" %>
...
<eo:SlideMenu runat="server" ID="Slidemenu1" NAME="Slidemenu1" SingleExpand="False" ControlSkinID="None"
    ...
    <LookItems>
        ...
        <eo:MenuItem Height="22" HoverStyle-CssText="padding-left: 15px; color: white; background-color: #cccccc"
            ItemID="_Default" NormalStyle-CssText="padding-left: 15px; color: black; background-color: #f0f0f0"></eo:MenuItem>
    </LookItems>
</eo:SlideMenu>
</asp:Content>
