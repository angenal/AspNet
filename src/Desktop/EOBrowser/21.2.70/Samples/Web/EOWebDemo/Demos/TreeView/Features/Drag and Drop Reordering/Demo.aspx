...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Demo.aspx.cs" Inherits="Demos_TreeView_Features_Drag_and_Drop_Reordering_Demo" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="demo" Runat="Server">
<p>
    EO.Web TreeView supports drag and drop reordering. By setting both <b>AllowDragDrop</b>
    and <b>AllowDragReordering</b>, you can drag a tree node not only onto another 
    tree node, but also between tree nodes. A black horizontal line is displayed 
    when the node would be dropped in between two tree nodes.
</p>
