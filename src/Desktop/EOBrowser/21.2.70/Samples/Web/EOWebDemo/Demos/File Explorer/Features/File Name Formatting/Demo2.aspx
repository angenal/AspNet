...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Demo2.aspx.cs" Inherits="Demos_File_Explorer_Features_File_Name_Formatting_Demo2" %>
...
<body>
    ...
    <div>
        ...
        function upload_done()
        {
            ...
            <p>
                It is often desired to automatically format file names to include date time 
                stamp or other information (for example, the current user name) in 
                order to better differentiate different files. EO.Web FileExplorer provides <strong>
                    FileUploaded</strong> event for you to implement any custom naming scheme.
            </p>
            <p>
                This sample automatically renames each file name to include the current date. 
                Try to upload a file and see it in action.
            </p>
            <eo:FileExplorer id="FileExplorer1" runat="server" RootFolder="~/Demos/File Explorer/Files" AllowCreateFolder="True"
                ...
                OnFileUploaded="FileExplorer1_FileUploaded">
                <LayoutTemplate>
