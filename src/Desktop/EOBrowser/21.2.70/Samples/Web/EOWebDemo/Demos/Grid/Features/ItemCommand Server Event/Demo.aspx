...
<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Demo.aspx.cs" Inherits="Demos_Grid_Features_ItemCommand_Server_Event_Demo"
    Title="Untitled Page" %>
...
//<!--JS_SAMPLE_END-->
    ...
    <p>
        EO.Web Grid performs most tasks on the client side without posting back to the server.
        However it provides <b>raiseItemCommandEvent</b> client method for you to raises
        server side <b>ItemCommand</b> event whenever you wish to. The following sample
        demonstrates how to use this feature to trigger the server event when an item is
        selected (by default the Grid does not trigger any server event when an item is
        selected).
    </p>
    <eo:Grid ID="Grid1" runat="server" FixedColumnCount="1" BorderColor="#7F9DB9" BorderWidth="1px"
        ...
        GridLineColor="220, 223, 228" GridLines="Both" ColumnHeaderDividerImage="00050103"
        Font-Size="8.75pt" Font-Names="Tahoma" Width="380px" Height="200px" ClientSideOnItemSelected="OnItemSelected"
        ...
        <Columns>
            ...
            <eo:StaticColumn SortOrder="Ascending" HeaderText="Posted At" AllowSort="True" DataField="PostedAt">
            </eo:StaticColumn>
            <eo:StaticColumn HeaderText="Posted By" AllowSort="True" DataField="PostedBy">
            </eo:StaticColumn>
            <eo:StaticColumn Width="300" HeaderText="Topic" AllowSort="True" DataField="Topic">
            </eo:StaticColumn>
        </Columns>
