namespace PubSub.MessageHub
{
    ...
    /// </summary>
    public interface IMessagesHub : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Publishes the <paramref name="messages"/> on the <see cref="IMessageHub"/>.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="messages"></param>
        void Publishes<T>(params T[] messages);
        ...
        Guid Subscribes<T>(Action<T[]> action);
        ...
        /// <returns>The token representing the subscription</returns>
        Guid Subscribes<T>(Action<T[]> action, TimeSpan throttleBy);
