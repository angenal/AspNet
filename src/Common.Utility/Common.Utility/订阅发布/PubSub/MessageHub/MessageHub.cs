namespace PubSub.MessageHub
{
    ...
    public sealed class MessageHub : IMessageHub
    {
        ...
        /// Creates an instance of the <see cref="MessageHub"/>.
        /// </summary>
        public MessageHub(TimeSpan lazyTimeSpan)
        {
            _subscriptions = new Subscriptions();
            _isLazyProducer = true;
            _lazyProducer = new LazyProducer(lazyTimeSpan, ProducerAction);
        }
        ...
        public void Publishes<T>(params T[] messages)
        {
            ...
            foreach (var message in messages) Producer(msgType, message);
        }

        /// <summary>
        /// The Lazy Producer Action
        /// </summary>
        /// <param name="msgType">The message type</param>
        /// <param name="message"></param>
        private void ProducerAction(Type msgType, dynamic message)
        {
            Producer(msgType, message);
        }
