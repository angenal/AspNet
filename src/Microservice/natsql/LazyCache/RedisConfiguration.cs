...
namespace LazyCache
{
    ...
    public class RedisConfiguration
    {
        ...
        /// </summary>
        public int? ConnectRetry { get; set; } = DefaultConfiguration.DefaultConnectRetry;

        /// <summary>
        /// Timeout (ms) for connect operations
        /// </summary>
        public int? ConnectTimeout { get; set; } = DefaultConfiguration.DefaultConnectTimeout;
        ...
        /// </summary>
        public int? ConfigCheckSeconds { get; set; } = DefaultConfiguration.DefaultConfigCheckSeconds;
        ...
        /// </summary>
        public int? ResponseTimeout { get; set; } = DefaultConfiguration.DefaultSyncTimeout;
        ...
        /// </summary>
        public int? SyncTimeout { get; set; } = DefaultConfiguration.DefaultSyncTimeout;

        /// <summary>
        /// Time (ms) to allow for asynchronous operations
        /// </summary>
        public int? AsyncTimeout { get; set; } = DefaultConfiguration.DefaultSyncTimeout;
        ...
        /// </summary>
        public int? WriteBuffer { get; set; } = DefaultConfiguration.DefaultWriteBuffer;
